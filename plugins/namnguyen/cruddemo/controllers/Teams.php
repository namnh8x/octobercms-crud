<?php namespace Namnguyen\CrudDemo\Controllers;
...
class Teams extends Controller
{
    ...
    public $requiredPermissions = ['namnguyen.cruddemo.manage_teams'];
    
    public function __construct()
    {
        parent::__construct();

        BackendMenu::setContext('Namnguyen.CrudDemo', 'cruddemo', 'teams');
    }
    ...
    public function create_onSave()
    {
        ...
        // save team
        $teamModel = new \Namnguyen\CrudDemo\Models\Team;
